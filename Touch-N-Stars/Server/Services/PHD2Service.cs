...
namespace TouchNStars.Server.Services
{
    public class PHD2Service : IDisposable
    {
        ...
        public async Task<List<string>> GetCameraListAsync()
        {
            return await Task.Run(() =>
            {
                try
                {
                    lock (lockObject)
                    {
                        ...
                        return client.GetCameraList();
                    }
                }
                catch (Exception ex)
                {
                    lastError = ex.Message;
                    Logger.Error($"Failed to get camera list: {ex}");
        ...
        public async Task<string> GetSelectedCameraIdAsync()
        {
            return await Task.Run(() =>
            {
                try
                {
                    lock (lockObject)
                    {
                        ...
                        return client.GetSelectedCameraId();
                    }
                }
                catch (Exception ex)
                {
                    lastError = ex.Message;
                    Logger.Error($"Failed to get selected camera ID: {ex}");
                    return null;
                }
            });
        }
        ...
        public async Task<List<string>> GetCameraInstancesAsync()
        {
            return await Task.Run(() =>
            {
                try
                {
                    lock (lockObject)
                    {
                        ...
                        return client.GetCameraInstances();
                    }
                }
                catch (Exception ex)
                {
                    lastError = ex.Message;
                    Logger.Error($"Failed to get camera instances: {ex}");
                    return new List<string>();
                }
            });
        }
        ...
        // Set selected camera
        public async Task<bool> SetSelectedCameraAsync(string cameraId)
        {
            return await Task.Run(() =>
            {
                try
                {
                    lock (lockObject)
                    {
                        ...
                        client.SetSelectedCamera(cameraId);
                        lastError = null;
                        return true;
                    }
                }
                ...
                {
                    lastError = ex.Message;
                    Logger.Error($"Failed to set selected camera: {ex}");
                    return false;
                }
            });
        }
        ...
        // Get mount list
        public async Task<List<string>> GetMountListAsync()
        {
            return await Task.Run(() =>
            {
                try
                ...
                {
                    lastError = ex.Message;
                    Logger.Error($"Failed to get mount list: {ex}");
                    return new List<string>();
                }
            });
        }
        ...
        // Get selected mount
        public async Task<string> GetSelectedMountAsync()
        {
            return await Task.Run(() =>
            {
                try
                {
                    lock (lockObject)
                    {
                        ...
                        return client.GetSelectedMount();
                    }
                }
                catch (Exception ex)
                {
                    lastError = ex.Message;
                    Logger.Error($"Failed to get selected mount: {ex}");
                    return null;
                }
            });
        }
        ...
        // Set selected mount
        public async Task<bool> SetSelectedMountAsync(string mountId)
        {
            return await Task.Run(() =>
            {
                try
                {
                    lock (lockObject)
                    {
                        ...
                        client.SetSelectedMount(mountId);
                        lastError = null;
                        return true;
                    }
                }
                ...
                {
                    lastError = ex.Message;
                    Logger.Error($"Failed to set selected mount: {ex}");
                    return false;
                }
            });
        }

        public async Task<string> GetSelectedINDIMountDriverAsync()
        {
            return await Task.Run(() =>
            {
                try
                {
                    lock (lockObject)
                    {
                        ...
                        return client.GetSelectedINDIMountDriver();
                    }
                }
                catch (Exception ex)
                {
                    lastError = ex.Message;
                    Logger.Error($"Failed to get selected INDI mount driver: {ex}");
                    return null;
                }
            });
        }

        public async Task<bool> SetSelectedINDIMountDriverAsync(string driverName)
        {
            return await Task.Run(() =>
            {
                try
                {
                    lock (lockObject)
                    {
                        ...
                        client.SetSelectedINDIMountDriver(driverName);
                        lastError = null;
                        return true;
                    }
                }
                ...
                {
                    lastError = ex.Message;
                    Logger.Error($"Failed to set selected INDI mount driver: {ex}");
                    return false;
                }
            });
        }
